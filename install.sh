...
if [[ "$DISTRO" == "20" ]]; then
    apt_install php7.4-fpm php7.4-opcache php7.4 php7.4-common php7.4-gd php7.4-mysql php7.4-imap php7.4-cli php7.4-cgi php-pear php7.4-curl php7.4-intl php7.4-pspell php7.4-sqlite3 php7.4-tidy php7.4-xmlrpc php7.4-xsl php-imagick php7.4-zip php7.4-mbstring php7.4-memcache php7.4-memcached
    PHPVERSION=7.4
elif [[ "$DISTRO" == "22" ]]; then
    apt_install php8.2-fpm php8.2-opcache php8.2 php8.2-common php8.2-gd php8.2-mysql php8.2-imap php8.2-cli php8.2-cgi php8.2-curl php8.2-intl php8.2-pspell php8.2-sqlite3 php8.2-tidy php8.2-xmlrpc php8.2-xsl php8.2-zip php8.2-mbstring php8.2-memcache php8.2-memcached
    PHPVERSION=8.2
fi
...
echo "phpmya
dmin phpmyadmin/dbconfig-install boolean true" | sudo debconf-set-selections
