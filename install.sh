...
#
# Program:
#   Install yiimp on Ubuntu 20.04 & 22.04 running Nginx, MariaDB, and PHP 7.4/8.2
#   v2.3
################################################################################
...
if [ ! -f /etc/apt/sources.list.d/ondrej-php-focal.list ] && [ ! -f /etc/apt/sources.list.d/ondrej-php-jammy.list ]; then
...
if [[ ("$DISTRO" == "20") ]]; then
    ...
    apt_install php7.4-cgi php-pear imagemagick php7.4-curl php7.4-intl php7.4-pspell
    apt_install php7.4-recode php7.4-sqlite3 php7.4-tidy php7.4-xmlrpc php7.4-xsl php-imagick php7.4-zip
    apt_install php7.4-mbstring libpsl-dev libnghttp2-dev php7.4-memcache php7.4-memcached
...
if [[ ("$DISTRO" == "22") ]]; then
    ...
    apt_install php8.2-cgi php-pear imagemagick php8.2-curl php8.2-intl php8.2-pspell
    apt_install php8.2-sqlite3 php8.2-tidy php8.2-xmlrpc php8.2-xsl php-imagick php8.2-zip
    apt_install php8.2-mbstring libpsl-dev libnghttp2-dev php8.2-memcache php8.2-memcached
    apt_install php-mbstring php-zip php-gd php-json memcached php-memcache
    sudo phpenmod mbstring
    apt_install php-gettext
    echo
...
# Set up debconf selections for non-interactive installation
...
# Restart PHP-FPM service (adjust version as needed)
